...
class TestLoadMP3Methods(unittest.TestCase):
    ...
    def test_to_mp3(self):
        ...
        to_mp3(filename_without_extension,
               input_path_from_terminal,
               save_path_output,
               ffmpeg_path)
    ...
    def test_getting_filename(self):
        ...
        filename_without_extension = getting_filename(input_path_from_terminal)
        # self.assertTrue(filename_without_extension ==
        # filename_without_extension_expected) as an alternative
        self.assertEqual(filename_without_extension,
                         filename_without_extension_expected)
